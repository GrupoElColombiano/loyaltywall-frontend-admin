...
// MUI
import { Checkbox, FormControl, FormControlLabel, InputLabel, Modal, OutlinedInput } from "@mui/material";
...
export default function ModalPayPal({ modal, setModal }: IModalDataProps) {
    // Translation
        ...
        >
            <ModalContainer onSubmit={handleSubmit(onSubmit)}>
                <CardComponent
                    ...
                    description={t("PaymentMethods.paypal.modal.description")}
                    title={t("PaymentMethods.paypal.modal.title")}
                >
